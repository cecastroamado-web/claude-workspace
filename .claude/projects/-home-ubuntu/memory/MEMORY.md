...
- [Dashboard do canal Havan](ecommerce_havan_dashboard.md) — scraper 1×/dia 06h, 5 features jun/2026 (histórico, receita no cashflow, margem/P&L, sobre-estoque, conciliação+em-trânsito), KPIs do PDF nos cards (fat. varejo + ritmo 7d), backlog a faturar desconta trânsito, distribuição por filial. Pendências em [[ecommerce-havan-pendencias]].
