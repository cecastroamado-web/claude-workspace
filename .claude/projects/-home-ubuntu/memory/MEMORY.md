...
- [Dashboard do canal Havan](ecommerce_havan_dashboard.md) — scraper 1×/dia 06h, margem/P&L, conciliação+em-trânsito, analytics de expansão (rede 196: penetração, ruptura, demanda 120d A/B, 3 PDFs c/ heatmap filial×mês) + potencial no tempo (série diária, fórmula única PDF↔card). Pendências em [[ecommerce-havan-pendencias]].
