...
- [Dashboard do canal Havan](ecommerce_havan_dashboard.md) — scraper 1×/dia 06h, margem/P&L, conciliação+em-trânsito, KPIs do PDF nos cards, analytics de expansão (rede 196 lojas: penetração, ruptura na ponta, demanda 120d A/B, vendas por filial mensal + 2 PDFs novos). Pendências em [[ecommerce-havan-pendencias]].
